...
class GraphReasoning(nn.Module):
    def __init__(self, chnn_in, rd_sc, dila, n_iter, is_use_ca):
        super().__init__()
        self.n_iter = n_iter
        # PPM 生成三个节点 采用特征金字塔的形式
        ...
        self.edge = common.IAM(chnn_in//rd_sc)
    ...
    def forward(self, inputs, node=False):
        ...
        for ii in range(self.n_node):
            ...
            feat_rgb[ii], feat_dep[ii] = self.edge(feat_rgb[ii], feat_dep[ii])
